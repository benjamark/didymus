...
plt.subplot(331)
plt.imshow(intersection_grid[0, :, :], cmap='gray')
plt.subplot(332)
plt.imshow(intersection_grid[1, :, :], cmap='gray')
plt.subplot(333)
plt.imshow(intersection_grid[2, :, :], cmap='gray')
plt.subplot(334)
plt.imshow(intersection_grid[3, :, :], cmap='gray')
plt.subplot(335)
plt.imshow(intersection_grid[4, :, :], cmap='gray')
plt.subplot(336)
plt.imshow(intersection_grid[5, :, :], cmap='gray')
plt.subplot(337)
plt.imshow(intersection_grid[6, :, :], cmap='gray')
plt.subplot(338)
plt.imshow(intersection_grid[7, :, :], cmap='gray')
plt.subplot(339)
plt.imshow(intersection_grid[8, :, :], cmap='gray')
plt.xlabel('Z index')
plt.ylabel('Y index')
plt.tight_layout()
plt.show()
