...
output_dir = '/projects/cnncae/didymus/src/projects/drivAer_r1025_n23/surfer-stls-ext'
os.makedirs(output_dir, exist_ok=True)

file_path = f'/projects/cnncae/didymus/src/projects/drivAer_r1025_n23/stls_ext/{stl_no}.stl'
